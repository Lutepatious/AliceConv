...
int wmain(int argc, wchar_t** argv)
{
	...
	while (--argc) {
		...
		class VGMdata vgmdata(MMLs.end_time, chip, mako2form, (union MAKO2_Tone*)(inbuf + pM2HDR->chiptune_addr), (pM2HDR->CH_addr[0] - pM2HDR->chiptune_addr) / LEN_MAKO2_FM_PARAMETER, early_detune);
		vgmdata.make_init();
