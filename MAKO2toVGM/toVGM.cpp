...
void VGMdata::make_init(void)
{
	...
	const static unsigned char Init_YM2608[] = {
		0x56, 0x01, 0x00, 0x56, 0x00, 0x00, 0x56, 0x03, 0x00, 0x56, 0x02, 0x00, 0x56, 0x05, 0x00, 0x56, 0x04, 0x00,
		0x56, 0x08, 0x00, 0x56, 0x09, 0x00, 0x56, 0x0A, 0x00, 0x56, 0x07, 0xBF, 0x56, 0x27, 0x30,
		0x56, 0x90, 0x00, 0x56, 0x91, 0x00, 0x56, 0x92, 0x00, 0x56, 0x24, 0x70, 0x56, 0x25, 0x00, 0x56, 0x29, 0x83,
		0x56, 0xB4, 0xC0, 0x56, 0xB5, 0xC0, 0x56, 0xB6, 0xC0, 0x57, 0xB4, 0xC0, 0x57, 0xB5, 0xC0, 0x57, 0xB6, 0xC0 };
...
void VGMdata::finish(void)
{
	*this->vgm_pos++ = 0x66;
	...
	if (this->Ex_Vols_count) {
		this->vgm_extra_len = sizeof(VGM_HDR_EXTRA) + 1 + sizeof(VGMX_CHIP_DATA16);
	}
