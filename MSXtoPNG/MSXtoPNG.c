...
int wmain(int argc, wchar_t** argv)
{
	...
	while (--argc) {
		...
		size_t msx_start = hMSX.Start & 0x7FFF;
		size_t msx_start_x = msx_start % 64 * 2;
		size_t msx_start_y = msx_start / 64;
		...
		png_set_pHYs(png_ptr, info_ptr, 200, 100, PNG_RESOLUTION_METER);
